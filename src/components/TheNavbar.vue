<template>
    <div class="navbar">
        <router-link :to="{name: 'Home'}" class="logo">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100" height="34"
        ...
        <ul>
            <router-link :to="{name: 'PageProducts'}">
                UX Design
            </router-link>
            <router-link :to="{name: 'PageAnimations'}">
                2D Animations
            </router-link>
            <router-link :to="{name: 'PageResume'}">
                Resume
            </router-link>
        </ul>
    </div>
